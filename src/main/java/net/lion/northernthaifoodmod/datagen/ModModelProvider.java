...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerCrop(ModBlocks.KAPOK_CROP, KapokflowerCropBlock.AGE, 0, 1, 2, 3, 4, 5, 6);

        blockStateModelGenerator.registerCrop(ModBlocks.LAKSA_CROP, LaksaleafCropBlock.AGE, 0, 1, 2, 3, 4, 5, 6);
        blockStateModelGenerator.registerCrop(ModBlocks.LEMONGRASS_CROP, LemongrassCropBlock.AGE, 0, 1, 2, 3, 4, 5, 6);
        blockStateModelGenerator.registerCrop(ModBlocks.LONG_BEAN_CROP, LongbeanCropBlock.AGE, 0, 1, 2, 3, 4, 5, 6);
        ...
        blockStateModelGenerator.registerCrop(ModBlocks.SHALLOT_CROP, ShallotCropBlock.AGE, 0, 1, 2, 3, 4, 5, 6);
        blockStateModelGenerator.registerCrop(ModBlocks.SPEARMINT_CROP, SpearmintCropBlock.AGE, 0, 1, 2, 3, 4, 5, 6);

        blockStateModelGenerator.registerCrop(ModBlocks.TAMARIND_CROP, TamarindCropBlock.AGE, 0, 1, 2, 3, 4, 5, 6);
        ...
        blockStateModelGenerator.registerSimpleState(ModBlocks.POT);
